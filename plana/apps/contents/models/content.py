...
class Content(models.Model):
    ...
    title = models.CharField(_("Title"), max_length=512, default="", null=True)
    header = models.TextField(_("Header"), default="", null=True)
    body = models.TextField(_("Body"), blank=False, null=False)
    footer = models.TextField(_("Footer"), default="", null=True)
    aside = models.TextField(_("Sidebar"), default="", null=True)
