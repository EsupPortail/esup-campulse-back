...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='user',
            options={'default_permissions': [], 'verbose_name': 'Utilisateur', 'verbose_name_plural': 'Users'},
        ),
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(through='users.AssociationUsers', to='associations.Association', verbose_name='Associations'),
        ),
        migrations.AlterField(
            model_name='user',
            name='is_cas',
