...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            options={'verbose_name': 'Institution component', 'verbose_name_plural': 'Institution components'},
        ),
        migrations.AlterModelOptions(
            name='socialnetwork',
        ...
        migrations.AlterField(
            model_name='association',
            name='activity_field',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='associations.activityfield', verbose_name='Activity field'),
        ),
        migrations.AlterField(
            model_name='association',
            name='address',
        ...
        migrations.AlterField(
            model_name='association',
            name='institution',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='associations.institution', verbose_name='Institution'),
        ),
        migrations.AlterField(
            model_name='association',
            name='institution_component',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='associations.institutioncomponent', verbose_name='Institution component'),
        ),
        migrations.AlterField(
            model_name='association',
            name='is_enabled',
        ...
        migrations.AlterField(
            model_name='association',
            name='name',
            field=models.CharField(default='', max_length=250, unique=True, verbose_name='Nom'),
        ),
        migrations.AlterField(
            model_name='association',
            name='path_logo',
            field=models.CharField(default='', max_length=250, verbose_name='Logo path'),
        ),
        migrations.AlterField(
            model_name='association',
            name='phone',
        ...
        migrations.AlterField(
            ...
            name='association',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='associations.association', verbose_name='Association'),
        ),
        migrations.AlterField(
            model_name='socialnetwork',
            name='location',
