...
CSRF_TRUSTED_ORIGINS = "{{ csrf_trusted_origins }}".split() # ["https://campulse-api-demo.unistra.fr"]
...
MIGRATION_SITE_DOMAIN = "{{ migration_site_domain }}"  # "campulse-demo.unistra.fr"
