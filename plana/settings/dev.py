...
EMAIL_TEMPLATE_ACCOUNT_CONFIRMATION_URL = EMAIL_TEMPLATE_FRONTEND_URL + "register-verify-email/"
EMAIL_TEMPLATE_PASSWORD_RESET_URL = EMAIL_TEMPLATE_FRONTEND_URL + "password-reset-confirm/"
