...
- `$ aws s3api put-object-acl --endpoint-url AWS_S3_ENDPOINT_URL --bucket AWS_STORAGE_BUCKET_NAME --key FILE_PATH --acl public-read` : rendre un fichier lisible publiquement sur le serveur S3 (ajout de nouveau logo).
