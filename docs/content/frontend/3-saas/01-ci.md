...
- Créer un webhook au format suivant : `https://git.unistra.fr/api/v4/projects/<project-id>/ref/main/trigger/pipeline?token=<trigger-token>&ref=main` avec le trigger token fourni par l'Unistra et l'id du projet visé (40858 pour le front et 40857 pour le back)
...
Remplir le champ "Payload URL" : `https://git.unistra.fr/api/v4/projects/<project-id>/ref/main/trigger/pipeline?token=<trigger-token>&ref=main` avec le trigger token fourni par l'Unistra et l'id du projet visé (40858 pour le front et 40857 pour le back)
