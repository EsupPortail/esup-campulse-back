...
env.nginx_location_extra_directives = [
    ...
    'add_header Content-Security-Policy "upgrade-insecure-requests; default-src \'none\'; base-uri \'self\'; img-src \'self\'; script-src \'self\'; style-src \'self\'; frame-ancestors \'none\';"',
