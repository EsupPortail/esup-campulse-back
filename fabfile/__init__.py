...
env.nginx_location_extra_directives = [
    ...
    'add_header Content-Security-Policy "upgrade-insecure-requests; default-src \'none\'; base-uri \'self\'; connect-src \'self\'; font-src \'self\'; frame-ancestors \'self\'; frame-src \'self\'; img-src \'self\'; script-src \'self\' \'unsafe-inline\' \'unsafe-eval\' https://code.jquery.com https://stackpath.bootstrapcdn.com; style-src \'self\' \'unsafe-inline\' https://stackpath.bootstrapcdn.com; frame-ancestors \'none\';"',
